                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        @php
                                            // Decode detailed currency data from the first product purchase record (or any representative)
                                            $currencyData = [];
                                            if (isset($lims_product_purchase_data[0]->detailed_currency_data)) {
                                                $currencyData = json_decode(
                                                    $lims_product_purchase_data[0]->detailed_currency_data,
                                                    true,
                                                );
                                            }
                                        @endphp
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label><strong>Currency Exchange Rates</strong></label>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="number" step="0.0001"
                                                                        class="form-control currency-rate-input"
                                                                        name="detailed_currency_data[{{ $currency->id }}]"
                                                                        value="{{ $rate }}">
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if ($field->type == 'text')
                                                            <input type="text" name="{{ $field_name }}"
                                                                value="{{ $lims_purchase_data->$field_name }}"
                                                                class="form-control"
                                                        ...
                                                        @elseif($field->type == 'textarea')
                                                            <textarea rows="5" name="{{ $field_name }}" value="{{ $lims_purchase_data->$field_name }}"
                                                            ...
                                                            @foreach ($option_values as $value)
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="{{ $field_name }}"
                                                                        value="{{ $value }}"
                                                                        @if ($value == $lims_purchase_data->$field_name) {{ 'checked' }} @endif
                                                                        @if ($field->is_required) {{ 'required' }} @endif>
                                                                    {{ $value }}
                                                                </label>
                                                                &nbsp;
                                                        ...
                                                        @elseif($field->type == 'select')
                                                            ...
                                                            <select class="form-control" name="{{ $field_name }}"
                                                                ...
                                                                @foreach ($option_values as $value)
                                                                    <option value="{{ $value }}"
                                                                        @if ($value == $lims_purchase_data->$field_name) {{ 'selected' }} @endif>
                                                                        {{ $value }}</option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                        ...
                                                        @foreach ($lims_product_purchase_data as $product_purchase)
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control qty"
                                                                        name="qty[]"
                                                                        value="{{ $product_purchase->qty }}" required />
                                                                </td>
                                                                ...
                                                                <input type="hidden" class="original-cost"
                                                                    value="{{ $product_data->cost }}" />
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th id="total-discount">
                                                            {{ number_format((float) $lims_purchase_data->total_discount, $general_setting->decimal, '.', '') }}
                                                        </th>
                                                        <th id="total-tax">
                                                            {{ number_format((float) $lims_purchase_data->total_tax, $general_setting->decimal, '.', '') }}
                                                        </th>
                                                        <th id="total">
                                                            {{ number_format((float) $lims_purchase_data->total_cost, $general_setting->decimal, '.', '') }}
                                                        </th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (flag) {
                        ...
                        cols += '<td>' + data[1] + '</td>';
                        cols +=
                            '<td><input type="text" class="form-control qty" name="qty[]" value="1" required /></td>';
                        if ($('select[name="status"]').val() == 1)
                            cols +=
                            '<td class="recieved-product-qty d-none"><input type="text" class="form-control recieved" name="recieved[]" value="1"  /></td>';
                        else if ($('select[name="status"]').val() == 2)
                            cols +=
                            '<td class="recieved-product-qty"><input type="text" class="form-control recieved" name="recieved[]" value="1" /></td>';
                        else
                            cols +=
                            '<td class="recieved-product-qty d-none"><input type="text" class="form-control recieved" name="recieved[]" value="0" /></td>';
                        if (data[10]) {
                            cols +=
