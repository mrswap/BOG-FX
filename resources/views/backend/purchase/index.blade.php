    ...
    <script type="text/javascript">
        ...
        $('#purchase-table').DataTable({
            ...
            'columnDefs': [{
                ...
                {
                    targets: [5], // grand_total column
                    render: function(data, type, row) {
                        return data; // allow raw HTML
                    }
                },
                {
        ...
        function purchaseDetails(purchase) {
            var htmltext = '<strong>{{ trans('file.Date') }}: </strong>' + purchase[0] +
                ...
                '<br><strong>{{ trans('file.Currency') }}: </strong>' + purchase[26];
            if (purchase[27])
            ...
            if (purchase[25])
                htmltext += '<strong>{{ trans('file.Attach Document') }}: </strong><a href="documents/purchase/' +
                purchase[25] + '">Download</a><br>';
            htmltext += '<br><div class="row"><div class="col-md-6"><strong>{{ trans('file.From') }}:</strong><br>' +
                ...
                purchase[4] + '<br>' + purchase[5] + '<br>' + purchase[6] + '</div></div></div>';
