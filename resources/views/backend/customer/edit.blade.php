                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="base_currency_id" class="form-control" required>
                                            <option value="">-- Select Currency --</option>
                                            @foreach ($currencies as $currency)
                                                <option value="{{ $currency->id }}"
                                                    {{ $lims_customer_data->base_currency_id == $currency->id ? 'selected' : '' }}>
                                        ...
                                        <div class="{{ 'col-md-' . $field->grid_value }}">
                                            <div class="form-group">
                                                ...
                                                @elseif($field->type == 'textarea')
                                                    <textarea rows="5" name="{{ $field_name }}" value="{{ $lims_customer_data->$field_name }}"
                                                ...
                                                @elseif($field->type == 'select')
                                                    ...
                                                    <select class="form-control" name="{{ $field_name }}"
                                                        ...
                                                        @foreach ($option_values as $value)
                                                            <option value="{{ $value }}"
                                                                @if ($value == $lims_customer_data->$field_name) {{ 'selected' }} @endif>
                                                                {{ $value }}</option>
                                                        @endforeach
                                                    </select>
