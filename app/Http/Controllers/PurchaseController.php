...
class PurchaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($product_id as $i => $id) {
            ...
            $product_purchase['detailed_currency_data'] = json_encode($request->detailed_currency_data ?? []);
    ...
    public function edit($id)
    {
        ...
        if ($role->hasPermissionTo('purchases-edit')) {
            ...
            return view('backend.purchase.edit', compact('lims_warehouse_list', 'lims_supplier_list', 'lims_product_list_without_variant', 'lims_product_list_with_variant', 'lims_tax_list', 'lims_purchase_data', 'lims_product_purchase_data', 'currency_exchange_rate', 'custom_fields', 'currency_list'));
        } else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            foreach ($product_id as $key => $pro_id) {
                ...
                $product_purchase['detailed_currency_data'] = json_encode($request->input('detailed_currency_data'));
