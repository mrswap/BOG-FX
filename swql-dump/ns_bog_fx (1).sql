...
(6, 'Zambia Kwacha', 'ZMW', 1, 1, '2025-11-17 20:38:22', '2025-11-17 20:38:22');
...
--
-- Table structure for table `forex_matches`
--

CREATE TABLE `forex_matches` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `party_id` bigint(20) UNSIGNED NOT NULL,
  `ledger_type` enum('customer','supplier') NOT NULL,
  `base_currency_id` bigint(20) UNSIGNED NOT NULL,
  `debit_txn_id` bigint(20) UNSIGNED NOT NULL,
  `credit_txn_id` bigint(20) UNSIGNED NOT NULL,
  `matched_base_amount` decimal(15,4) NOT NULL,
  `debit_rate` decimal(15,6) NOT NULL,
  `credit_rate` decimal(15,6) NOT NULL,
  `realised_gain` decimal(20,4) NOT NULL DEFAULT 0.0000,
  `realised_loss` decimal(20,4) NOT NULL DEFAULT 0.0000,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `forex_remittances` (
  ...
  `party_id` bigint(20) UNSIGNED NOT NULL,
  `ledger_type` enum('customer','supplier') NOT NULL,
  `voucher_type` enum('sale','purchase','payment','receipt') NOT NULL,
  ...
  `local_amount` decimal(20,4) NOT NULL,
  `avg_rate` decimal(15,6) DEFAULT NULL,
  `closing_rate` decimal(15,6) DEFAULT NULL,
  `direction` enum('debit','credit') NOT NULL,
  `settled_base_amount` decimal(15,4) NOT NULL DEFAULT 0.0000,
  `remaining_base_amount` decimal(15,4) NOT NULL DEFAULT 0.0000,
  `realised_gain` decimal(20,4) NOT NULL DEFAULT 0.0000,
  `realised_loss` decimal(20,4) NOT NULL DEFAULT 0.0000,
  `unrealised_gain` decimal(20,4) NOT NULL DEFAULT 0.0000,
  `unrealised_loss` decimal(20,4) NOT NULL DEFAULT 0.0000,
...
INSERT INTO `parties` (`id`, `name`, `type`, `company_name`, `vat_number`, `email`, `phone`, `address`, `city`, `state`, `postal_code`, `country`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'Test Multi Forex Party', 'both', 'Test Co', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-11-17 19:52:36', '2025-11-17 19:52:36'),
(2, 'Kafue Chemicals Ltd', 'supplier', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-11-17 20:38:22', '2025-11-17 20:38:22');
...
CREATE TABLE `party_payments` (
  ...
  `related_invoice_type` enum('sale','purchase') DEFAULT NULL,
  `currency_id` bigint(20) UNSIGNED NOT NULL,
  `exchange_rate` decimal(15,6) NOT NULL DEFAULT 1.000000,
  `paid_usd` decimal(20,4) DEFAULT 0.0000,
  `paid_local` decimal(20,4) DEFAULT 0.0000,
  `payment_mode` enum('cash','bank','cheque','forex','other') DEFAULT 'cash',
  `remarks` text DEFAULT NULL,
...
INSERT INTO `party_payments` (`id`, `party_type`, `party_id`, `payment_reference`, `related_invoice_id`, `related_invoice_type`, `currency_id`, `exchange_rate`, `paid_usd`, `paid_local`, `payment_mode`, `remarks`, `payment_date`, `created_by`, `created_at`, `updated_at`) VALUES
(6, 'supplier', 1, 'v2', NULL, NULL, 2, 75.000000, 200.0000, 15000.0000, 'forex', NULL, '2025-11-13', 1, '2025-11-12 22:40:19', '2025-11-12 22:40:19');
...
--
-- Indexes for table `forex_matches`
--
